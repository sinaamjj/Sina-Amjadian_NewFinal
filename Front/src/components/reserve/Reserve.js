...
import { calculateDuration, formatPrice } from "@/lib/date";
...
function ReserveSection({ tour }) {
  ...
  const handlePurchase = async () => {
    ...
    if (!gender) {
      toast.error("انتخاب جنسیت الزامی است ❌");
      return;
    }
    ...
    const orderData = {
      ...
      nationalCode: trimmedNationalId,
      gender,
